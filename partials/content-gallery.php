...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="page-header">
		<hgroup>
			<?php the_title( '<h2 class="entry-title black-block"><a href="' . get_permalink() .'" title="' . sprintf( esc_attr__( 'Permalink to %s', 'the-bootstrap' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark">', '</a></h2>' ); ?>
